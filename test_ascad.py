...
# transformer.py, fast_attention.py, data_utils.py, evaluation_utils.py
try:
    ...
    print("⚠️ Make sure transformer.py, fast_attention.py, data_utils.py, and evaluation_utils.py are in this folder!")
    sys.exit(1)
...
def compute_rank(predictions, test_data, limit):
    ...
    if final_rank < 1.0:
        ...
        print("⚠️ Attack not yet successful.")
